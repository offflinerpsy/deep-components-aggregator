...
// --- Локальный прокси для парсинга ---
export function buildLocalProxyUrl(targetUrl) {
  const localProxy = process.env.LOCAL_PROXY_URL || "http://localhost:8080";
  return `${localProxy}/proxy/${targetUrl}`;
}
